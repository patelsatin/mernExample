...
const About=()=> {
  ...
  const callAboutPage=async ()=>{
   try{
     ...
     if(!res.status===200){
       window.alert("If working aboutpage method")
              ...
              <div className="card mt-3">
                <ul className="list-group list-group-flush">
                  <li className="list-group-item d-flex justify-content-between align-items-center flex-wrap">
                    ...
                    <span className="text-secondary">https://{userData.name}.com</span>
                  </li>
                  <li className="list-group-item d-flex justify-content-between align-items-center flex-wrap">
                ...
                <div className="card-body">
                  <div className="row">
                    <div className="col-sm-3">
                     <label for="#po"> <h6 className="mb-0">Full Name</h6></label>
                    </div>
                    <div className="col-sm-9 text-secondary" id="po">
                    {userData.name}
                    </div>
                  </div>
                  ...
                  <div className="row">
                    <div className="col-sm-3">
                    <label for="#po1"> <h6 className="mb-0">Email</h6></label>
                    </div>
                    <div className="col-sm-9 text-secondary" id="po1">
                    {userData.email}
                    </div>
                  </div>
                  ...
                  <div className="row">
                    <div className="col-sm-3">
                    <label for="#po2"> <h6 className="mb-0" >Mobile</h6></label>
                    </div>
                    <div className="col-sm-9 text-secondary" id="po2">
                    {userData.phone}
                    </div>
                  </div>
                  ...
                  <div className="row">
                    <div className="col-sm-3">
                    <label for="#po3"> <h6 className="mb-0">Designation</h6></label>
                    </div>
                    <div className="col-sm-9 text-secondary" id="po3">
                     {userData.work}
                    </div>
                  </div>
                  ...
                  <div className="row">
                    <div className="col-sm-3">
                    <button type="button" className="btn btn-success btn_edit">Edit Profile</button>
                  </div>
                  </div>
              ...
              <div className="row gutters-sm">
                <div className="col-sm-6 mb-3">
                  <div className="card h-100">
                    <div className="card-body">
                      <h6 className="d-flex align-items-center mb-3">Skills Status</h6>
                      <large>Web Design</large>
                      <div className="progress mb-3" style={{height: "10px"}}>
                        <div className="progress-bar bg-primary" role="progressbar" style={{width: "80%"}} aria-valuenow="80" aria-valuemin="0" aria-valuemax="100"></div>
                      </div>
                      <large>Website Markup</large>
                      <div className="progress mb-3" style={{height:"10px"}}>
